...
class Board
    ...
    # Fin de partie : Victoire ? Match nul ?
    def game_ending
    ...
    def is_the_end(symbol)
     return @cases[0].symbol == symbol && @cases[1].symbol == symbol && @cases[2].symbol == symbol || #vérifie une victoire Horizontale pour
        ...
        @cases[0].symbol == symbol && @cases[3].symbol == symbol && @cases[6].symbol == symbol || #vérifie une victoire verticale pour
        ...
        @cases[0].symbol == symbol && @cases[4].symbol == symbol && @cases[8].symbol == symbol || #vérifie una victoire diagonale
